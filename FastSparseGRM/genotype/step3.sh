...
dx run swiss-army-knife \
  ...
  -icmd='
    ...
    R CMD BATCH --vanilla "--args --prefix.in chrall_pruned --file.seg output.seg --degree 4 --file.div output.divergence.div --prefix.out output.unrelated" extractUnrelated_wrapper.R extractUnrelated.Rout && 
