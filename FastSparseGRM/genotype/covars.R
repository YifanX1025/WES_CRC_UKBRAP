...
covar <- data %>%
  ...
  mutate(ethnicity=ifelse(ethnicity==1001|ethnicity==2001|ethnicity==3001|ethnicity==4001,"White",
                          ifelse(ethnicity==1002|ethnicity==2002|ethnicity==3002|ethnicity==4002,"Mixed",
                                 ifelse(ethnicity==1003|ethnicity==2003|ethnicity==3003|ethnicity==4003,"Asian or Asian British",
                                        ifelse(ethnicity==2004|ethnicity==3004,"Black or Black British",
