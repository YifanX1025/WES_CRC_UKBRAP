...
for chr in {1..22}; do
  dx run swiss-army-knife \
    ...
    -icmd="
      ...
      zcat ukb23157_c${chr}_merged_v1_staar_trimmed.vcf.gz | awk 'BEGIN{OFS=\"\t\"} /^#/ {print} !/^#/ {if(\$7==\".\") \$7=\"PASS\"; print}' | bgzip > ukb23157_c${chr}_merged_v1_staar_trimmed_fixed.vcf.gz && 
      bcftools index -t ukb23157_c${chr}_merged_v1_staar_trimmed_fixed.vcf.gz
    " \
